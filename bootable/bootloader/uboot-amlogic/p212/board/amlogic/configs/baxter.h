...
/*
 * board/amlogic/configs/baxter.h
 *
...
#ifndef __GXL_BAXTER_V1_H__
#define __GXL_BAXTER_V1_H__
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"setenv bootargs ${bootargs} androidboot.slot_suffix=${active_slot} u-boot_version=${ver};"\
            "\0"\
        "switch_bootmode="\
            "get_rebootmode;"\
        ...
        "recovery_from_flash="\
            ...
            "\0"\
        "init_display="\
            "osd open;osd clear;imgread pic logo ${logo_name} $loadaddr;bmp display $bootup_offset;bmp scale"\
            "\0"\
        "bcb_cmd="\
            "get_valid_slot;"\
            "\0"\
...
#define CONFIG_DEVICE_PRODUCT	"needle"
