...
#define CONFIG_SOC_VREF      0//(1+ (50+((50*48)/(48+480/(6+1)))))// (738/12) //0 //0  is auto --70 ---range 44.07---88.04   %
#define CONFIG_DRAM_VREF   0//(1+ (50+((50*34)/(34+60))))// (810/12) // 0 //77 //0 //0  is auto ---70 --range -- 45---92.50    %
...
ddr_set_t __ddr_setting = {
	...
	.t_pub_zq1pr			= 0x0006fc5d,   //PUB ZQ1PR//0x3f95d, 0x4f95d,
	.t_pub_zq2pr			= 0x0006fc5d,   //PUB ZQ2PR//0x3f95d, 0x4f95d,
