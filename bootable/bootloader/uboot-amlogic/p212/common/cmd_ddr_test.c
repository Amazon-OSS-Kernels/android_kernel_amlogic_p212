...
// ----------------------------
#if (CONFIG_CHIP==CHIP_TXLX)
#ifdef PERIPHS_PIN_MUX_0 /// (PERIPHS_PIN_MUX_0==  (0xff634400 + (0x2c << 2)))
//#if (PERIPHS_PIN_MUX_0 ==  (0xff634400 + (0x2c << 2)))
#else
...
int do_ddr_set_bist_test_loop_counter_use_sticky_5(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{

 char *endp;

unsigned int ddr_bist_test_loop_count=0;
	...
	ddr_bist_test_loop_count = simple_strtoull_ddr(argv[1], &endp,0);
	//ddr_bist_test_loop_count=ddr_bist_test_loop_count&0xffffffe0;
	if (*argv[1] == 0 || *endp != 0) {
ddr_bist_test_loop_count=1;
	}



printf("ddr_bist_test_loop_count 0x[%08x],\n", ddr_bist_test_loop_count);



#if ( CONFIG_DDR_PHY>=P_DDR_PHY_905X)
	
         writel((ddr_bist_test_loop_count<<0) , PREG_STICKY_REG5);
printf("Set STICKY_REG5 [0x%08x]\n", readl(PREG_STICKY_REG5));
...
int do_ddr_set_bist_test_loop_delay_use_sticky_4(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{

 char *endp;

unsigned int ddr_bist_test_loop_delay=0;
unsigned int ddr_bist_test_rerun_place_flag=0;
	...
	ddr_bist_test_loop_delay = simple_strtoull_ddr(argv[1], &endp,0);
	//ddr_bist_test_loop_count=ddr_bist_test_loop_count&0xffffffe0;
	if (*argv[1] == 0 || *endp != 0) {
ddr_bist_test_loop_delay=1;
	}
  if (argc >2) {
	ddr_bist_test_rerun_place_flag = simple_strtoull_ddr(argv[2], &endp, 16);
        if (*argv[2] == 0 || *endp != 0)
			{
			ddr_bist_test_rerun_place_flag = 0;
			}
	}


printf("ddr_bist_test_loop_delay 0x[%08x],\n", ddr_bist_test_loop_delay);
printf("ddr_bist_test_rerun_place_flag 0x[%08x],\n", ddr_bist_test_rerun_place_flag);


#if ( CONFIG_DDR_PHY>=P_DDR_PHY_905X)
	
         writel((ddr_bist_test_loop_delay<<0)|(ddr_bist_test_rerun_place_flag<<16) , PREG_STICKY_REG4);
printf("Set STICKY_REG4 [0x%08x]\n", readl(PREG_STICKY_REG4));
...
#define  DDR_TEST_CMD__DDR_SET_BIST_TEST_LOOP_COUNTER_STICKY_5  0x31
#define  DDR_TEST_CMD__DDR_SET_BIST_TEST_LOOP_DELAY_STICKY_5  0x32
...
printf("or  ddr_test_cmd 0x17 1200 6034 60346034 0 0 0 0 1 \n");
	...
	printf("\n  0x29  DDR_TEST_CMD__DDR4_DDR_BIST_TEST_USE_D2PLL_STICKY    ddr_test_cmd 0x29   start_freq  0xff000000 ");
	printf("\n  0x30 DDR_TEST_CMD__DDR_SET_BIST_TEST_SIZE_STICKY_6     ddr_test_cmd 0x30  test_size");
	printf("\n  0x31 DDR_TEST_CMD__DDR_SET_BIST_TEST_LOOP_COUNTER_STICKY_5     ddr_test_cmd 0x31  test_loops  ");
	printf("\n  0x31 DDR_TEST_CMD__DDR_SET_BIST_TEST_LOOP_delay_STICKY_4     ddr_test_cmd 0x32  test_loops_delay  ");
...
//printf("or  ddr_test_cmd 0x17 1200 0x2aa4a 0x2015995d 0x09 0x20 0 50 \n");
	...
	break;
	 case(DDR_TEST_CMD__DDR_SET_BIST_TEST_LOOP_COUNTER_STICKY_5):
		{
	//	run_command("ddr_test_cmd 0x31
	 printf("\nset ddr bist test loop times use sticky5 register\n");

	 do_ddr_set_bist_test_loop_counter_use_sticky_5((cmd_tbl_t * )cmdtp, (int) flag,( int) argc2, (argv2));
		}
	break;
		 case(DDR_TEST_CMD__DDR_SET_BIST_TEST_LOOP_DELAY_STICKY_5):
		{
	//	run_command("ddr_test_cmd 0x32 3000 0 
	 printf("\nset ddr bist test loop times use sticky4 register\n");

	 do_ddr_set_bist_test_loop_delay_use_sticky_4((cmd_tbl_t * )cmdtp, (int) flag,( int) argc2, (argv2));
		}
	break;
}
