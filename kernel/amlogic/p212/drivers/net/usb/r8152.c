...
static void r8152b_disable_eee(struct r8152 *tp)
{
	u32 ocp_data;
	...
	ocp_reg_write(tp, OCP_EEE_CONFIG1, 0xc07f);
	ocp_reg_write(tp, OCP_EEE_CONFIG2, 0x7030);
	ocp_reg_write(tp, OCP_EEE_CONFIG3, 0xffe6);
	...
	ocp_reg_write(tp, OCP_EEE_DATA, 0);
