...
struct downstream_topo_info {
	uint8_t max_devs_exceeded;
	uint8_t max_cascade_exceeded;
	uint8_t v2_0_repeater_down; /* only in 22 */
	uint8_t v1_X_device_down; /* only in 22 */
...
struct hdmitx_info {
	...
	/*--------------Lip Sync----------------------------------*/
	unsigned char p_latency_present; /*  progressive latency */
	uint16_t p_audio_latency;/* progressive audio latency in ms */
	uint16_t p_video_latency;/* progressive video latency in ms */
	/*--------------------------------------------------------*/
};
